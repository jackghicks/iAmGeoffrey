...
function Sprite(img, sx, sy, sWidth, sHeight) {
    ...
    this.scale = 1;
    this.rotation = 0;
    this.rotationHotSpot = [0,0];

    this.draw = function(x, y, camera)
    {
        camera.drawImage(this.img, this.sx, this.sy, this.sWidth, this.sHeight, x, y, this.sWidth, this.sHeight, this.rotation, this.rotationHotSpot, this.scale);
    }
}